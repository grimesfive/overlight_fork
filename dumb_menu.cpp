...
void menu_maybe_init ( void )
{
	...
	menu_item_add(menu_main, NULL, "\tOverLight Mod v3", ID_NONE, MENU_COLOR_SEPARATOR, NULL);
	...
	menu_item_add(OverLight_HUD_Settings, NULL, "\aFont Nickname Size: \\", ID_FONT_NICK_SIZE, MENU_COLOR_DEFAULT, NULL, "Press ENTER for save, and restart the game");
